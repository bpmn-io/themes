...
All notable changes to [@bpmn-io/c4-theme](https://github.com/bpmn-io/themes) are documented here. We use [semantic versioning](http://semver.org/) for releases.
...
* `FEAT`: theme the form-js viewer and editor ([#12](https://github.com/bpmn-io/themes/pull/12))
* `FEAT`: take the checked checkbox, radio and toggle state from the design system's accent ([#14](https://github.com/bpmn-io/themes/pull/14))
